      ...
      <HomePageLayout>
        <div className="header-about flex items-center mt-15 ">
          <p className="w-3/4 text-lg/9 p-10 rounded-md bg-[#4caf50]  ">
            ...
            traveling, etc. There are some caring instructions for each plant,
            which is also friendly to people who have 0 experience for looking
            after plants. After you log in, you can see all the plants which are
